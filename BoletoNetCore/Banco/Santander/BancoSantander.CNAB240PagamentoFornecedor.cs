...
namespace BoletoNetCore
{
    ...
    partial class BancoSantander : IBancoCNAB240PagamentoFornecedor
    {
        ...
        public string GerarHeaderLoteRemessaCNAB240PagamentoFornecedor(ref int numeroArquivoRemessa, ref int numeroRegistro)
        {
            try
            {
                var reg = new TRegistroEDI();
        ...
        public string GerarDetalheRemessaCNAB240PagamentoFornecedor(Boleto boleto, ref int registro)
        {
        ...
        private string GerarDetalheSegmentoPRemessaCNAB240PagamentoFornecedor(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                numeroRegistroGeral++;
        ...
        private string GerarDetalheSegmentoQRemessaCNAB240PagamentoFornecedor(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                numeroRegistroGeral++;
        ...
        private string GerarDetalheSegmentoRRemessaCNAB240PagamentoFornecedor(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                string codMulta;
        ...
        private string GerarDetalheSegmentoSRemessaCNAB240PagamentoFornecedor(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
        ...
        public string GerarTrailerLoteRemessaCNAB240PagamentoFornecedor(ref int numeroArquivoRemessa, int numeroRegistroGeral, int numeroRegistroCobrancaSimples, decimal valorCobrancaSimples, int numeroRegistroCobrancaVinculada, decimal valorCobrancaVinculada, int numeroRegistroCobrancaCaucionada, decimal valorCobrancaCaucionada, int numeroRegistroCobrancaDescontada, decimal valorCobrancaDescontada)
        {
            try
            {
        ...
        public void LerHeaderRetornoCNAB240PagamentoFornecedor(ArquivoRetorno arquivoRetorno, string registro)
        {
        ...
        public void LerDetalheRetornoCNAB240SegmentoTPagamentoFornecedor(ref Boleto boleto, string registro)
        {
            try
            {
        ...
        public void LerDetalheRetornoCNAB240SegmentoUPagamentoFornecedor(ref Boleto boleto, string registro)
        {
            try
            {
                //Valor do Título
